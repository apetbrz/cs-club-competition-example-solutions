...
int main(){
    ...
    //================Step 1================
        ...
        for(int i = 0; i < n; i++){
            ...
            //some fancy pants ASCII magic. since characters *are* just
            //numeric values representing specific ASCII characters,
            //you can get the int value of a digit by taking its ASCII
            //value and subtracting the value of the digit '0'
            //for example, '0' has the value 48, so if we take '3' (51) and subtract
            //'0' (48) we get 3!
            int waterUsed = (int)order[0] - '0';
